...
author: "Andrea, Anna, Helle, Maria, Mia"
date: "07/01/2021"
...
ggplot(d.k, aes(grid,posterior.k)) +  geom_point() +geom_line()+theme_classic()+  geom_line(aes(grid, prior/dens),color= 'green')+  xlab("Kristian's knowledge of CogSci")+ ylab("posterior probability")+ggtitle("Grid approximation using the updated prior")
```
