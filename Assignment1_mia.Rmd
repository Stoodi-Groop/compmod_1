...
#plot plot plot
ggplot(d, aes(grid,posterior.k)) +  geom_point() + geom_line() + 
  theme_classic() + geom_line(aes(grid, uniform.prior/dens),color= 'red') +  
  xlab("Knowledge of CogSci") + ylab("posterior probability")
...
#plot plot plot
ggplot(d, aes(grid,posterior.d)) +  geom_point() + geom_line() + 
  theme_classic() + geom_line(aes(grid, uniform.prior/dens),color= 'red') +  
  xlab("Knowledge of CogSci") + ylab("posterior probability")
```
...
#plot plot plot
ggplot(d, aes(grid,posterior.m)) +  geom_point() + geom_line() + 
  theme_classic() + geom_line(aes(grid, uniform.prior/dens),color= 'red') +  
  xlab("Knowledge of CogSci") + ylab("posterior probability")
```
