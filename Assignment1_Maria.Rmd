...
Riccardo's initial estimated knowledge of cogsci was etsimated using a grid approximation. A uniform prior was implemented, and the likelihood was calculated from 3 correct answers out of 6 possible. As is seen from the posterior distribution, his knowledge is at chance level.
...
```
The same was done using a quadratic approximation. Assuming that the posterior is Gaussian, the posterior is maximized at 0.5, and its standard deviation is 0.2.
...
#Draw the plot
ggplot(new.r, aes(grid,posterior.r)) +  geom_point() +geom_line()+theme_classic()+  geom_line(aes(grid, prior),color= 'green')+xlab("Riccardo's knowledge of CogSci")+ ylab("posterior probability")+ggtitle("Grid approximation using the updated prior")
...
#Draw the plot
ggplot(new.k, aes(grid,posterior.k)) +  geom_point() +geom_line()+theme_classic()+  geom_line(aes(grid, prior),color= 'green')+xlab("Kristian's knowledge of CogSci")+ ylab("posterior probability")+ggtitle("Grid approximation using the updated prior")
...
#Compute the likelihood at each value in grid
likelihood.d <- dbinom(9 , size = 10 , prob = p_grid )
...
#Draw the plot
ggplot(new.d, aes(grid,posterior.d)) +  geom_point() +geom_line()+theme_classic()+  geom_line(aes(grid, prior),color= 'green')+xlab("Daina's knowledge of CogSci")+ ylab("posterior probability")+ggtitle("Grid approximation using the updated prior")
...
#Compute the likelihood at each value in grid
likelihood.k <- dbinom(148 , size = 172 , prob = p_grid )
...
#Draw the plot
ggplot(new.m, aes(grid,posterior.m)) +  geom_point() +geom_line()+theme_classic()+  geom_line(aes(grid, prior),color= 'green')+xlab("Kristian's knowledge of CogSci")+ ylab("posterior probability")+ggtitle("Grid approximation using the updated prior")
